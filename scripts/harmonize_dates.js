...
// Harmoniser les dates dans le fichier sous-pref_harmonises.json
...
const sousPrefHarmonises = sousPref.map(item => {
  ...
  // Harmoniser les champs de dates
...
fs.writeFileSync('./resources/data/sous-pref_dates_harmonisees.json', JSON.stringify(sousPrefHarmonises, null, 2));
fs.writeFileSync('./resources/data/secretaires_dates_harmonisees.json', JSON.stringify(secretaires, null, 2));
...
console.log(`- ./resources/data/sous-pref_dates_harmonisees.json`);
console.log(`- ./resources/data/secretaires_dates_harmonisees.json`); 